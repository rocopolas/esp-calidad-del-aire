            ...
            <ul>
                <li><a href="#">Menu</a>
                    <ul>
                        ...
                        <li><a href="#2"">Control</a></li>
                        <li><a href="#3">Carpeta tecnica</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
        <h1>ESP CALIDAD DEL AIRE</h1>
    </header>
    <body>
        <h1 href="#1" class="titulo">Inicio</h1>
        <p>asdasdasdasdsda</p>
        <h1 href="#2" class="titulo">Control</h1>
        <p>Temperatura: TEMP01</p>
        <p>Calidad del aire: CAL01</p>
        <p>Estado ventiladores: VEN01</p>
        <div>
